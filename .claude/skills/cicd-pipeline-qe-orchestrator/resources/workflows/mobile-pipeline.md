...
```javascript
Task('Localization Testing', 'Test all 7 languages including RTL for Arabic', 'qe-test-executor');
...
```javascript
Task('ASO Visual Check', 'Validate app store screenshots and previews', 'qe-visual-tester');
```
