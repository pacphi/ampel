...
**Tests (13 files):**
30. `tests/README.md`
31. `tests/deepl_integration.rs`
32. `tests/integration_tests.rs`
33. `tests/validation_only_tests.rs`
...
**CI/CD (5 files):**
48. `.github/workflows/i18n-validation.yml`
49. `scripts/install-git-hooks.sh`
50. `scripts/i18n-coverage-report.js`
51. `scripts/i18n-validate.sh`
52. `.yamllint.yml`
