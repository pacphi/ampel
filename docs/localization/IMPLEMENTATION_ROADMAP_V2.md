...
test('no hardcoded left/right in CSS', () => {
  const cssFiles = fs.readdirSync('src/styles', { recursive: true })
  ...
  const forbiddenProperties = [
    ...
    'left', 'right', // Only in absolute positioning context
  ];
...
const SUPPORTED_LANGUAGES = [
  'en', 'pt-BR', 'es-ES', 'de', 'fr', 'he', 'ar', 'th', 'fi', 'cs',
  'ko', 'tr', 'vi', 'nl', 'sr', 'ru', 'it', 'pl', 'zh-CN', 'ja'
];
